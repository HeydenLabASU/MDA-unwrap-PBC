...
import MDA_unwrap_PBC  # noqa



# -- Project information -----------------------------------------------------

project = "MDA-unwrap-PBC"
copyright = (
    "2024, Matthias Heyden. "
...
htmlhelp_basename = "MDA-unwrap-PBCdoc"
...
latex_documents = [
    (master_doc, "MDA-unwrap-PBC.tex", "MDA-unwrap-PBC Documentation",
     "MDA-unwrap-PBC", "manual"),
]
