"""
MDAunwrapPBC --- :mod:`MDA_unwrap_PBC.analysis.MDAunwrapPBC`
===========================================================

This module contains the :class:`MDAunwrapPBC` class.
...
class MDAunwrapPBC(AnalysisBase):
    """MDAunwrapPBC class.
